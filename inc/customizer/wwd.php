	...
	public function register_options( $wp_customize ) {
		...
		JetBlack_Customizer_Utilities::register_option(
			array(
				...
				'description'       =>  sprintf( esc_html__( 'If you want camera icon, save "fa fa-camera". For more classes, check %1$sthis%2$s', 'jetblack' ), '<a href="' . esc_url( 'https://fontawesome.com/icons?d=gallery&m=free' ) . '" target="_blank">', '</a>' ),
				'section'           => 'jetblack_ss_wwd',
				'active_callback'   => array( $this, 'is_wwd_visible' ),
			)
		);
